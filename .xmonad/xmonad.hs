...
myAppGrid = [   
                ...
                , ("Polichromatic", "polychromatic-controller")
                , ("Spotify", "spotify")
                , ("Dmenu Configs", "codium ~/.config/dmscripts")
                , ("Xmonad Configs", "codium ~/.xmonad")
                , ("AnyDesk", "anydesk")
            ]
  ...
  where
    ...
    manageRanger = customFloating $ W.RationalRect l t w h
               where
                 ...
                 t = 0.95 -h
                 l = 0.95 -w
    spawnBtop  = myTerminal ++ " -T btop -e btop"
    findBtop   = title =? "btop"
...
myWorkspaces = [" dev ", " www ", " mail ", " doc ", " vbox ", " chat ", " mus ", " vid ", " games "]
...
myManageHook = composeAll
     ...
     , className =? "VSCodium"     --> doShift ( myWorkspaces !! 0 )
     , className =? "Thunderbird"   --> doShift ( myWorkspaces !! 2)
     , className =? "Mail"   --> doShift ( myWorkspaces !! 2 )
...
myKeys =
    ...
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        , ("M-y", spawn "dm-youtube")          -- screenshots (images)
    ...
    -- KB_GROUP Floating windows
        ...
        , ("M-S-s", sinkAll)                       -- Push ALL floating windows to tile
    ...
    -- Toggle them to hide and it sends them back to hidden workspace (NSP).
        ...
        , ("M-s", namedScratchpadAction myScratchPads "pavucontrol")
        , ("M-e", namedScratchpadAction myScratchPads "ranger")
...
main = do
    ...
    xmproc0 <- spawnPipe ("xmobar -x 0 $HOME/.config/xmobar/" ++ colorScheme ++ "-xmobarrc-withtray")
